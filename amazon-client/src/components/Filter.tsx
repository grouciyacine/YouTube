...
function Filter() {
    return (
        <div className='bg-white   w-full border-r-2 border-gray-200  flex-col justify-start items-start'>
            <h4 className='font-bold text-sm p-2 text-start'>Department</h4>
            <h4 className='font-bold text-sm  mx-6 text-start'>Computers</h4>
            ...
            <h4 className='font-bold text-sm  mx-6 text-start'>Business Type</h4>
            ...
            <h4 className='font-bold text-sm  mx-6 text-start'>More-sustainable Products</h4>
            <div className='flex flex-row justify-start items-center mx-6 space-x-2'>
                <input type='checkbox' name='Climate Pledge Friendly' value='Climate Pledge Friendly' />
                <label>Climate Pledge Friendly</label>
            </div>
            <h4 className='font-bold text-sm  mx-6 text-start'>Augmented Reality</h4>
            <div className='flex flex-row justify-start items-center mx-6 space-x-2'>
            ...
            <h4 className='font-bold text-sm  mx-6 text-start'>Featured Brands</h4>
            <div className='flex flex-row justify-start items-center mx-6 space-x-2'>
            ...
            <h4 className='font-bold text-sm  mx-6 text-start'>Packaging Option</h4>
            <div className='flex flex-row justify-start items-center mx-6 space-x-2'>
            ...
            <h4 className='font-bold text-sm  mx-6 text-start'>Price</h4>
